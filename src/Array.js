import gowns1 from './assets/img/gowns/gowns1.jpg'
...
import jacket1 from './assets/img/jacket/top1.jpg'
...
const item = [
  ...
  // },
  {
    ...
    image: shorts4,
    category: "shorts",
    description: "Stay cozy and stylish with this cotton hoodie. It's perfect for those cool evenings and is designed for maximum comfort.",
    review: "I love this cotton hoodie! It's super comfortable and the size one is a perfect fit. It keeps me warm on chilly nights, and the quality is excellent."
  },
  {
    id: 4,
    price: 20,
    ...
    image: shorts5,
    category: "shorts",
    description: "Express your unique style with this graphic t-shirt. The eye-catching design and comfortable fabric make it a great addition to your wardrobe.",
    review: "The graphic t-shirt is awesome! The size one fits me just right, and the design is cool. It's my go-to casual shirt for a stylish look."
  },
  {
    id: 5,
    price: 50,
  ...
  },
  {
    ...
    image: trouser2,
    category: "pants",
    description: "Stay practical and stylish with these cargo pants. They provide ample pocket space and are suitable for various outdoor activities.",
    review: "Cargo pants are a must for me, and these are perfect! The size one fits comfortably, and they have plenty of pockets for all my essentials."
  },
  {
    id: 11,
    price: 40,
    ...
    image: jacket3,
    category: "jackets",
    description: "Add a touch of luxury to your wardrobe with this suede jacket. Its soft texture and warm lining make it a great choice for colder weather.",
    review: "I'm in love with this suede jacket! The size one is cozy and stylish, and it keeps me warm in the winter. It's a great investment."
  },
  {
    id: 12,
    price: 20,
